...
blocked_paths='^(CLAUDE\.md|GEMINI\.md|HERMES\.md|\.hermes\.md|CODEX\.md|AGENTS\.local\.md|CLAUDE\.local\.md|GEMINI\.local\.md|HERMES\.local\.md|metactl\.yaml|metactl\.lock\.json|\.claudeignore|\.codexignore|\.cursorignore|\.geminiignore|\.mcp\.json|opencode\.json|\.metactl/|\.agents/|\.codex/|\.codex-goal/|\.claude/|\.cursor/|\.gemini/|\.hermes/|(.*/)?\.omc/|(.*/)?\.opendream/|\.ruler/|\.aider/|\.windsurf/|\.superpowers/|docs/superpowers/|(.*/)?memory/|(.*/)?notepads/|(.*/)?scratch/|\.tmp/|tmp/|frontend/node_modules/|node_modules/|\.mypy_cache/|\.pytest_cache|\.ruff_cache/|htmlcov/|\.coverage|skills/|Modelfile\.|.*\.code-workspace$|.*\.zip$)'
allowed_agent_docs='^(AGENTS\.md|opendream/AGENTS\.md|tests/AGENTS\.md|\.meta/spec-adapters/AGENTS\.md)$'
agent_doc_paths='(^|/)(AGENTS|CLAUDE|GEMINI|HERMES|CODEX)\.md$'
...
content_markers="/Users/[[:alnum:]_.-]+|/home/[[:alnum:]_.-]+|[A-Za-z]:\\\\Users\\\\|internal URL:|internal_url|https?://internal"
while IFS= read -r path; do
  case "$path" in
