...
OpenDream is alpha software. Public claims are intentionally bounded to what
...
| Public package hygiene | Public artifacts must not contain local paths, secrets, account-specific details, non-public URLs, or generated runtime state. | `CLEAN_ROOM.md`, `scripts/check_public_boundary.sh` |
