...
| Package hygiene | Release artifacts must not contain local paths, secrets, account-specific details, internal URLs, or generated runtime state. | `CLEAN_ROOM.md`, `scripts/check_release_hygiene.sh` |
