...
Shows `prepare-context` selecting prior repo guidance for the next agent workspace task.
...
Runs the project-agent showcase eval and summarizes stateless score, memory-assisted score, lift, and negative controls.
