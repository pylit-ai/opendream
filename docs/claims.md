...
| Clean-room posture | "OpenDream code is maintained with explicit clean-room and vendored-asset provenance." | `CLEAN_ROOM.md`, `THIRD_PARTY_NOTICES.md`, `scripts/check_provenance_risk.py` | This is release hygiene, not legal advice. |
