...
| `gemini` | Instruction-only `GEMINI.md` block plus shell hooks | `verify activation-capture` runs generated shell hooks directly; host auto-invocation remains instruction-only. |
